  ...
  rec {
    ...
    tarball =
      pkgsStaticLinux.releaseTools.binaryTarball rec {
        src = pkgsStaticLinux.pkgsMusl.haskellPackages.dhall-json;
    ...
    shell = (pkgs.haskell.lib.doBenchmark pkgs.haskellPackages.dhall-json).env;
  }
